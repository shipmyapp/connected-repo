...
15. **Offline-First (V1):** ~~Make app offline-first, free version offline-only, paid gets cloud sync~~ 🔄 PARTIAL - Auth caching + PGlite IndexedDB foundation implemented, cloud sync pending
